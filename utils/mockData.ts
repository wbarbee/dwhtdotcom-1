...
export const mockFullSeason: Game[] = [
	...
	{ ...baseMockGame, id: '8', away: 'Arkansas Razorbacks', opponentId: '12', opponentName: 'Arkansas Razorbacks', isRivalry: true, rivalryName: 'Southwest Classic', isConferenceGame: true, status: 'STATUS_FINAL', result: 'win', homeTeamScore: 35, awayTeamScore: 17, texasScore: 35, opponentScore: 17, pointDifferential: 18, score: '17 - 35', homeTeamRank: 4, awayTeamRank: 22, date: '11/8/2025', timestamp: new Date('2025-11-08').getTime() },
